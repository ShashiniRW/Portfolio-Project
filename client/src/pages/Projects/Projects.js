    ...
    <>
      <div className="container project">
        ...
        <p className="pb-3 text-center">
          ...
          voluptate qui et animi doloribus nulla eius molestiae unde tempore a
        </p>
        {/* card design */}
          ...
          <div className="col-md-4">
            <div class="card rounded">
              ...
              <div className="card-body text-center">
                ...
                <a
                  className="ad-btn"
                  href="https://github.com/ShashiniRW/ShashiniRW"
                >
                  View
                </a>
              </div>
          ...
          <div className="col-md-4">
            <div class="card rounded">
              <div className="card-image">
                ...
                <img
                  src="https://media.geeksforgeeks.org/wp-content/uploads/20240701150157/Backend-Development.webp"
                  alt="project3"
                />
              </div>
              <div className="card-image-overly m-auto mt-3">
